...
@Component({
    selector: 'e-commerce-borrower-rents',
    templateUrl: './borrower-rents.component.html',
    styleUrls: ['./borrower-rents.component.scss'],
    animations: fuseAnimations
})
export class BorrowerRentsComponent implements OnInit {
